...
# local_pdf_path = r"C:\Users\jgarcia\source\repos\GEN_MEMORIAS\data\input_files\Cuentas.pdf"  # Reemplaza esto con la ruta real de tu archivo PDF

        
local_pdf_path=input("\nIntroduce la ruta del archivo: ")
...
while True:
    ...
    # Prompt
    template = """Utiliza las siguientes piezas de contexto para responder la pregunta al final.
